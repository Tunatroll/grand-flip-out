...
- **Jagex compliant** — uses public APIs (OSRS Wiki, RuneLite); the optional grandflipout.com features (off by default, consent-gated) send your IP, GE offers, approximate coins and (if you link an account) your starred watchlist items — plus, when flip-sync is on, your contributed flips logged to your account — to grandflipout.com; see the in-client disclosure
