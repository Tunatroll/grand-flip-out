...
public interface GrandFlipOutConfig extends Config
{
    ...
    @ConfigItem(
        ...
        description = "Add 'GFO: Lookup' to right-click menu on any tradeable item. Shows margin, volume, ROI, and buy limit in chat.",
        section = overlaySection,
        position = 5
    )
    ...
    @ConfigSection(
        name = "P2P Network",
        description = "Peer-to-peer relay network for distributed pricing",
        position = 9
    )
